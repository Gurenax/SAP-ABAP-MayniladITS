    ...
    LOOP AT lt_balances ASSIGNING <fs_balances>.
      IF <fs_balances>-net_date LE pa_ddate.
        ...
        ELSE.
          ...
          IF <fs_balances>-disc_due LT pa_ddate.
            "--Summarize Due Amounts
            pv_balance = pv_balance + <fs_balances>-amount.
          ENDIF.
        ENDIF.
...
*
*      WRITE : / co_misc, <fs_misc_inst>-opbel, 'INSTALLMENT PLAN', lv_misc1, pv_misc, '--- MISC INSTALLMENT'.
*
...
*      WRITE:/ co_misc, <fs_misc_inst>-opbel, 'INSTALLMENT PLAN', lv_misc1_not_yet_due, pv_misc, '--- NOT YET DUE FROM MISC INSTALLMENT: '.
*    ENDIF.
