...
*& 10/01/2013 | GDIMALIWAT|  45334    | Updated to resolve Panaya issues
*&---------------------------------------------------------------------*
...
TYPES:  BEGIN OF ty_upload,
          ...
          aadf_no         TYPE anlu-zz_aadf_no,       "-- AADF No.
          aadf_date       TYPE anlu-zz_aadf_date,     "-- AADF Date
          ...
          brand           TYPE anlu-ZZBRAND,          "-- Brand
          type            TYPE anlu-ZZTYPE,           "-- Type
          engas_code      TYPE anlu-ZZENGAS_CODE,     "-- Engas Code
          article_code    TYPE anlu-ZZARTCLE_CODE,    "-- Article Code
          loan_package    TYPE anlu-ZZLOAN_PACKAGE,   "-- Loan Package
          loan_currency   TYPE anlu-ZZ_LOAN_CURRENCY, "-- Loan Currency
          proof_owner     TYPE anlu-ZZ_PROOF_OWNER,   "-- Proof Owner
          lot_no          TYPE anlu-ZZ_LOT_NO,        "-- Lot No
          survey_no       TYPE anlu-ZZ_SURVEY_NO,     "-- Survey No
          or_no           TYPE anlu-ZZ_OR_NO,         "-- OR No.
          or_date         TYPE anlu-ZZ_OR_DATE,       "-- OR Date
          zone            TYPE anlu-ZZ_ZONE,          "-- Zone
          invtag_no       TYPE anlu-ZZ_INVTAG_NO,     "-- Inventory Tag No.
          former_acct     TYPE anlu-ZZ_FORMER_ACCT,   "-- Former Accountable
    ...
    DO.
      ...
      IF sy-subrc EQ 0.
        ...
        SPLIT gs_string-string AT co_tab INTO <fs_upload>-asset_category  "-- Asset Category
                                              ...
                                              <fs_upload>-aadf_no         "-- AADF No.
                                              <fs_upload>-aadf_date       "-- AADF Date
                                              ...
                                              <fs_upload>-brand           "-- Brand
                                              <fs_upload>-type            "-- Type
                                              <fs_upload>-engas_code      "-- Engas Code
                                              <fs_upload>-article_code    "-- Article Code
                                              <fs_upload>-loan_package    "-- Loan Package
                                              <fs_upload>-loan_currency   "-- Loan Currency
                                              <fs_upload>-proof_owner     "-- Proof Owner
                                              <fs_upload>-lot_no          "-- Lot No
                                              <fs_upload>-survey_no       "-- Survey No
                                              <fs_upload>-or_no           "-- OR No.
                                              <fs_upload>-or_date         "-- OR Date
                                              <fs_upload>-zone            "-- Zone
                                              <fs_upload>-invtag_no       "-- Inventory Tag No.
                                              <fs_upload>-former_acct     "-- Former Accountable
...
FORM change_general_data.
  ...
  LOOP AT gt_upload ASSIGNING <fs_upload>.
    ...
    mc_bdc_dynpro:  co_flag 'SAPLAIST'              '0100',
                    ...
                    space   'ANLU-ZZ_AADF_NO'       <fs_upload>-aadf_no,         "-- AADF No.
                    space   'ANLU-ZZ_AADF_DATE'     <fs_upload>-aadf_date,       "-- AADF Date
                    ...
                    space   'ANLU-ZZBRAND'          <fs_upload>-brand,           "-- Brand
                    space   'ANLU-ZZTYPE'           <fs_upload>-type,            "-- Type
                    space   'ANLU-ZZENGAS_CODE'     <fs_upload>-engas_code,      "-- Engas Code
                    space   'ANLU-ZZARTCLE_CODE'    <fs_upload>-article_code,    "-- Article Code
                    space   'ANLU-ZZLOAN_PACKAGE'   <fs_upload>-loan_package,    "-- Loan Package
                    space   'ANLU-ZZ_LOAN_CURRENCY' <fs_upload>-loan_currency,   "-- Loan Currency
                    space   'ANLU-ZZ_PROOF_OWNER'   <fs_upload>-proof_owner,     "-- Proof Owner
                    space   'ANLU-ZZ_LOT_NO'        <fs_upload>-lot_no,          "-- Lot No
                    space   'ANLU-ZZ_SURVEY_NO'     <fs_upload>-survey_no,       "-- Survey No
                    space   'ANLU-ZZ_OR_NO'         <fs_upload>-or_no,           "-- OR No.
                    space   'ANLU-ZZ_OR_DATE'       <fs_upload>-or_date,         "-- OR Date
                    space   'ANLU-ZZ_ZONE'          <fs_upload>-zone,            "-- Zone
                    space   'ANLU-ZZ_INVTAG_NO'     <fs_upload>-invtag_no,       "-- Inventory Tag No.
                    space   'ANLU-ZZ_FORMER_ACCT'   <fs_upload>-former_acct,     "-- Former Accountable
