...
DATA: BEGIN OF it_line OCCURS 0,
      ...
      budat like ekbe-budat, "Document Date
      budat2      TYPE bkpf-budat, "Posting Date
...
loop at it_po.
  ...
  select ebelp belnr buzei gjahr bewtp budat menge wrbtr
    ...
    select single belnr budat tcode
      into (it_line-acc_doc_num, it_line-budat2, it_line-tcode)
      from bkpf
  ...
  if sy-subrc EQ 0.
    ...
    TRANSFER 'Vendor No|Vendor Name|PO Number|Document Date|Posting Date|Transaction Code|Document Number|Total|Material Document|Project Definition|Activity|PO Line Item|PO Net Price per Unit|Quantity Charged|UM|Amount Charged' to p_file.
...
*        endif.
      ...
      write:/ '--------', it_line-budat, it_line-budat2, it_line-tcode, it_line-acc_doc_num, tmp_total, it_line-belnr, it_line-projdef, it_line-bewtp, it_line-ebelp, it_line-network, it_line-pronr, it_line-netpr, it_line-menge, it_line-wrbtr,
it_line-erfme, it_line-activity.

      CONCATENATE it_po-lifnr it_po-name1 it_po-ebeln it_line-budat it_line-budat2 it_line-tcode it_line-acc_doc_num tmp_total2
                  it_line-belnr it_line-projdef it_line-activity it_line-ebelp it_line-netpr it_line-menge it_line-erfme it_line-wrbtr
