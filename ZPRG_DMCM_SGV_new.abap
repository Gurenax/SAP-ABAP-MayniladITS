...
*& DESCRIPTION: Extraction of DMCM Details
*&---------------------------------------------------------------------*
...
*&---------------------------------------------------------------------*
*& 2013/11/22| GDIMALIWAT |46861      | Revised program for Maynilad ABAP Standards
*&---------------------------------------------------------------------*
*&
*&  Report format is:
...
REPORT zprg_dmcm_sgv MESSAGE-ID zisu.
*INCLUDE
...
TYPES: BEGIN OF ty_dmcm_load_add,
      ...
      BEGIN OF ty_dmcm_all,
        ...
        hvorg           TYPE dfkkop-hvorg,
        tvorg           TYPE dfkkop-tvorg,
        billingclass    TYPE eanlh-aklasse,
        gpart           TYPE fkkvkp-gpart,
        billdoc         TYPE dfkkop-opbel,
        ratecode        TYPE easts-tarifart,
...
*&
CONSTANTS:  co_prefix type string value 'DMCM_',
...
FORM write_to_file .
  ...
  IF sy-subrc EQ 0.
    LOOP AT gt_dmcm_all ASSIGNING <fs_dmcm_all>.
      ...
      CONCATENATE <fs_dmcm_all>-gpart <fs_dmcm_all>-vkont <fs_dmcm_all>-gsber <fs_dmcm_all>-billingclass
                  <fs_dmcm_all>-ratecode <fs_dmcm_all>-augbl lv_amount_str <fs_dmcm_all>-budat
                  <fs_dmcm_all>-opbel <fs_dmcm_all>-source INTO lv_string SEPARATED BY '|' RESPECTING BLANKS.
...
FORM begin_extract .
  ...
  DATA: lv_gpart        TYPE fkkvkp-gpart,
        ...
        lv_tarifart     TYPE easts-tarifart.
  ...
  IF sy-subrc EQ 0.
    ...
    LOOP AT gt_dmcm_load_add ASSIGNING <fs_dmcm_load_add>.
      ...
      INTO lv_anlage
      FROM ever
      WHERE vkonto EQ <fs_dmcm_load_add>-vkont.
...
*      WHERE acct_nb EQ <fs_dmcm_load_add>-vkont.
      ...
      IF ( <fs_dmcm_load_add>-opbel >= '000100000000' AND <fs_dmcm_load_add>-opbel < '000200000000' )
        ...
        <fs_dmcm_all>-sctax = <fs_dmcm_load_add>-sctax.
        <fs_dmcm_all>-xblnr = <fs_dmcm_load_add>-xblnr.
        <fs_dmcm_all>-augrd = <fs_dmcm_load_add>-augrd.
        <fs_dmcm_all>-blart = <fs_dmcm_load_add>-blart.
        <fs_dmcm_all>-gsber = <fs_dmcm_load_add>-gsber.
        <fs_dmcm_all>-hvorg = <fs_dmcm_load_add>-hvorg.
        <fs_dmcm_all>-tvorg = <fs_dmcm_load_add>-tvorg.
        <fs_dmcm_all>-billingclass = lv_aklasse.
        <fs_dmcm_all>-gpart = lv_gpart.
        <fs_dmcm_all>-ratecode = lv_tarifart.
        <fs_dmcm_all>-opbel = <fs_dmcm_load_add>-opbel.
        <fs_dmcm_all>-augbl = ''.
        <fs_dmcm_all>-source = 'OPBEL'.
...
*     Get taxed amount only.
  ...
  IF sy-subrc EQ 0.
    LOOP AT gt_dmcm_load_neg ASSIGNING <fs_dmcm_load_neg>.
      ...
      INTO lv_anlage
      FROM ever
      WHERE vkonto EQ <fs_dmcm_load_neg>-vkont.
...
*      WHERE acct_nb EQ <fs_dmcm_load_neg>-vkont.
      ...
      IF ( ( <fs_dmcm_load_neg>-augbl >= '000100000000' AND <fs_dmcm_load_neg>-augbl < '000200000000' ) OR ( <fs_dmcm_load_neg>-augbl >= '000500000000' AND <fs_dmcm_load_neg>-augbl < '000600000000' ) )
        ...
        <fs_dmcm_all>-xblnr = <fs_dmcm_load_neg>-xblnr.
        <fs_dmcm_all>-augrd = <fs_dmcm_load_neg>-augrd.
        <fs_dmcm_all>-blart = <fs_dmcm_load_neg>-blart.
        <fs_dmcm_all>-gsber = <fs_dmcm_load_neg>-gsber.
        <fs_dmcm_all>-hvorg = <fs_dmcm_load_neg>-hvorg.
        <fs_dmcm_all>-tvorg = <fs_dmcm_load_neg>-tvorg.
        <fs_dmcm_all>-billingclass = lv_aklasse.
        <fs_dmcm_all>-gpart = lv_gpart.
        <fs_dmcm_all>-ratecode = lv_tarifart.
        <fs_dmcm_all>-opbel = <fs_dmcm_load_neg>-augbl.
        <fs_dmcm_all>-augbl = <fs_dmcm_load_neg>-opbel.
        <fs_dmcm_all>-source = 'AUGBL'.
